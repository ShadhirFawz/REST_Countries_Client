        ...
        <div className="bg-gray-800 bg-opacity-60 backdrop-blur-sm rounded-xl shadow-xl pb-12 pt-2 pl-7 pr-7 border border-gray-700">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full py-3 px-4 bg-indigo-800 hover:bg-blue-900 text-white font-serif rounded-lg transition-colors duration-300 flex cursor-pointer justify-center items-center ${
